...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Budgeting & Forecasting", url: "/budgeting", icon: Calculator, roles: ["Admin", "PropertyManager", "CFO", "Analyst"] },
      { title: "Accounts Payable / Receivable", url: "/accounts", icon: Receipt, roles: ["Admin", "CFO"] },
      { title: "Procurement & Inventory", url: "/procurement", icon: ShoppingCart, roles: ["Admin", "PropertyManager", "CFO"] },
  ...
  },
  {
    ...
    layerTag: "CRM",
    items: [
      { title: "Lease Management", url: "/lease-management", icon: FileText, roles: ["Admin", "PropertyManager"] },
      { title: "Residents", url: "/residents", icon: Users, roles: ["Admin", "PropertyManager"] },
      { title: "Move-In / Move-Out", url: "/move-in-out", icon: ArrowDownToLine, roles: ["Admin", "PropertyManager"] },
      { title: "Units", url: "/units", icon: Home, roles: ["Admin", "PropertyManager"] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "Parking & Vehicles", url: "/parking", icon: Car, roles: ["Admin", "PropertyManager"] },
      { title: "Packages & Delivery", url: "/packages", icon: Package, roles: ["Admin", "PropertyManager"] },
      { title: "Key & Access Control", url: "/access-control", icon: Key, roles: ["Admin", "PropertyManager"] },
      { title: "Safety & Security", url: "/safety", icon: ShieldOff, roles: ["Admin", "PropertyManager"] },
      { title: "Pest Control", url: "/pest-control", icon: Bug, roles: ["Admin", "PropertyManager"] },
      { title: "Utility Management", url: "/utilities", icon: Droplets, roles: ["Admin", "PropertyManager", "CFO"] },
    ],
  },
  {
  ...
  },
  {
    ...
    layerTag: "OPS",
    items: [
      { title: "Portfolio Overview", url: "/portfolio", icon: Building, roles: ["Admin", "PropertyManager", "CFO", "Analyst"] },
      { title: "Capital Projects", url: "/capital-projects", icon: HardHat, roles: ["Admin", "PropertyManager", "CFO"] },
